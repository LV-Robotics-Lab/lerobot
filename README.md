...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owning group                     | Policy training integration group                                                                                                                                                                                            |
| Repository role                  | `policy-source` / lab-maintained LeRobot training fork                                                                                                                                                                       |
| Lifecycle                        | `active`                                                                                                                                                                                                                     |
| Software integration status      | Training, dataset, and policy adaptations are in scope. Hardware-specific integrations are owned by wrapper repositories and Prometheus hardware branches; remaining historical snapshots require separate migration audits. |
| Field hardware acceptance status | Not asserted by this policy source. Serial-bus discovery, calibration, motion, collection, and soak acceptance belong to the corresponding Prometheus hardware branch and require a separately dated field record.           |
| Last governance check            | 2026-08-17                                                                                                                                                                                                                   |
