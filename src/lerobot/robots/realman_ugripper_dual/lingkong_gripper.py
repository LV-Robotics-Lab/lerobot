...
# lingkong_grip_api.py + grpc_client.py 所在目录
# 本文件: .../lerobot_tactile_ws/lerobot/src/lerobot/robots/realman_ugripper_dual/lingkong_gripper.py
_GRIP_API_DIR = Path(__file__).resolve().parents[5] / "ugripper" / "zxd_test_ugrp"
...
class LingkongGripper:
    ...
    def connect(self, max_retries: int = 5, retry_delay: float = 2.0) -> bool:
        ...
        if str(_GRIP_API_DIR) not in sys.path:
